    ...
    <div className="relative flex-1 md:flex-none md:absolute md:inset-0 md:flex md:items-center pointer-events-none z-10">
      <div className="max-w-xl md:max-w-3xl lg:max-w-6xl px-6 py-8 md:py-0 md:px-16 lg:px-24">
        ...
        <div className="mt-8 pointer-events-auto">
          <a
            href="#discover"
            className="group inline-flex items-center gap-3 font-display text-sm md:text-base font-semibold tracking-[0.15em] uppercase text-white border border-white/30 px-8 py-4 rounded-sm transition-all duration-500 hover:bg-zneako-orange hover:text-zneako-black hover:border-zneako-orange"
          >
            Discover Zneako
        ...
        <p className="mt-10 font-display text-xs md:text-sm font-semibold tracking-[0.15em] uppercase text-zneako-orange">
          Giving rubber a second life.
        </p>
        <p className="mt-2 font-body text-xs text-zneako-sand/70 max-w-sm leading-relaxed">
